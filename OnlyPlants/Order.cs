...
namespace OnlyPlants
{
    public partial class Order
    {
        ...
        public Order(int quantity, string deliveryType, int orderID, double deliveryTime, List<Product> productList)
        {
            _quantity = quantity;
        ...
        public double DeliveryTime { get => _deliveryTime; set => _deliveryTime = value; }
