...
<body>
    <form runat="server">
        <section class="menu menu2 cid-sgaMjCw33X" once="menu" id="menu2-12">
        <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
            <div class="container-fluid">
                <div class="navbar-brand">
                    <span class="navbar-logo">
                        <a href="~/Default" runat="server"><img src="assets/images/onlyplants-1110x258.png" alt="OnlyPlants" style="height: 4.6rem;"></a>
                    </span>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                        <li class="nav-item">
                            <a class="nav-link link text-black text-primary display-4" href="~/Login" runat="server">
                                Login
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link link text-black text-primary display-4" href="~/Plants" runat="server">
                                Plants
                            </a>
                        </li>
                        <li class="nav-item"><a class="nav-link link text-black text-primary display-4" href="~/Seeds" runat="server">Seeds</a></li>
                        <li class="nav-item">
                            <a class="nav-link link text-black text-primary display-4" href="~/Pots" runat="server">Pots</a>
                        </li>
                    </ul>
                    <div class="navbar-buttons mbr-section-btn">
                        <a class="btn btn-primary display-4" href="~/Checkout" runat="server">
            ...
            <div class="row justify-content-center mt-4">
                <div class="dragArea row">
                    ...
                    <div class="col-12 form-group" data-for="url">
                        <asp:TextBox runat="server" CssClass="form-control" ID="card_tb" TextMode="Number"></asp:TextBox>
                    </div>
                    <div class="col-12 form-group" data-for="textarea">
                        <asp:TextBox runat="server" placehodler="Leave additional notes" CssClass="form-control" ID="notes_tb" TextMode="MultiLine"></asp:TextBox>
                    </div>
    ...
    <section class="footer3 cid-sgaNoV01rM" once="footers" id="footer3-13">
        <div class="container">
