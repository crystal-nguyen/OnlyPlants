<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="OnlyPlants._Default" %>
...
<body>
    <form runat="server">
        <section class="menu menu2 cid-sgaMjCw33X" id="menu2-u">
        ...
        <section class="header3 cid-sgaKODUfw6 mbr-fullscreen" id="header3-n">
            <div class="align-center container">
                <div class="row justify-content-end">
                    <div class="col-12 col-lg-6">
                        <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>You don't have to be obscene</strong></h1>
                        <p class="mbr-text mbr-fonts-style display-7"><em>...to get yourself some greens</em></p>
                    </div>
                </div>
            </div>
        </section>

        <section class="footer3 cid-sgaNoV01rM" id="footer3-v">
            <div class="container">
        ...
        <section style="background-color: #fff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Arial, sans-serif; color: #aaa; font-size: 12px; padding: 0; align-items: center; display: flex;">
            ...
            <p style="flex: 0 0 auto; margin: 0; padding-right: 1rem;"><a href="https://mobirise.site/z" style="color: #aaa;"></a></p>
        </section>
